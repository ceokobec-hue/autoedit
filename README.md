...
**맥(Apple Silicon)에서 만들었고, 맥·윈도우 둘 다에서 도는 것을 확인했습니다.**
다만 **컴퓨터마다 사정이 달라 안 될 수 있습니다** — 운영체제 버전, 이미 깔린 프로그램,
그래픽카드 유무에 따라 갈립니다. 윈도우를 쓰신다면 [윈도우에서 쓰기](#윈도우에서-쓰기) 를 먼저 보세요.
...
**윈도우** — [윈도우에서 쓰기](#윈도우에서-쓰기) 를 먼저 읽으세요
...
| | |
|---|---|
| **맥(Apple Silicon) 기준으로 만들었습니다** | M1 이상. 인텔 맥은 ffmpeg 경로만 바꾸면(`FFMPEG=` 환경변수) 대체로 됩니다. 윈도우는 [윈도우에서 쓰기](#윈도우에서-쓰기) |
...
다만 **컴퓨터마다 사정이 다릅니다.** 윈도우는 맥과 달리 ffmpeg 을 직접 받아야 하고,
받은 빌드에 따라 **자막 필터가 없을 수 있습니다.** 그래픽카드 유무로 굽는 방식도 갈립니다.
그래서 **안 될 수 있습니다.** 막히시면 [Issues](https://github.com/ceokobec-hue/autoedit/issues) 에
**`python doctor.py` 결과를 그대로** 붙여 주세요. 그게 제일 빠릅니다.
